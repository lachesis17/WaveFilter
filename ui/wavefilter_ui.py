...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u"ui/icons/colors.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionLine_Colors.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"ui/icons/play.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"ui/icons/stop.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
