...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSave_Session = QAction(MainWindow)
        self.actionSave_Session.setObjectName(u"actionSave_Session")
        icon = QIcon()
        icon.addFile(u"ui/icons/save.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave_Session.setIcon(icon)
        self.actionLoad_Session = QAction(MainWindow)
        self.actionLoad_Session.setObjectName(u"actionLoad_Session")
        icon1 = QIcon()
        icon1.addFile(u"ui/icons/load.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionLoad_Session.setIcon(icon1)
        self.actionTrim = QAction(MainWindow)
        self.actionTrim.setObjectName(u"actionTrim")
        icon2 = QIcon()
        icon2.addFile(u"ui/icons/trim.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionTrim.setIcon(icon2)
        self.actionExport = QAction(MainWindow)
        self.actionExport.setObjectName(u"actionExport")
        icon3 = QIcon()
        icon3.addFile(u"ui/icons/export.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"ui/icons/colors.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionLine_Colors.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u"ui/icons/play.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"ui/icons/stop.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.menuFile.addAction(self.actionTrim)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave_Session.setText(QCoreApplication.translate("MainWindow", u" Save Session", None))
        self.actionLoad_Session.setText(QCoreApplication.translate("MainWindow", u" Load Session", None))
        self.actionTrim.setText(QCoreApplication.translate("MainWindow", u" Trim to Selection", None))
