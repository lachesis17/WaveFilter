...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(u"ui/icons/colors.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionLine_Colors.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"ui/icons/play.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"ui/icons/stop.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
